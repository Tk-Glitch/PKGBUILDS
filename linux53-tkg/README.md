A custom Linux kernel 5.3.y with specific PDS & BMQ CPU schedulers related patchset selector (stock CFS and CFS+TurboSched are also an option) and added tweaks for a nice interactivity/performance balance, aiming for the best gaming experience.
