# Nvidia driver 418.30 (beta), 418.42.02 (Vulkan dev), 415.27 (short lived) & 418.43 (long lived)
...
418.42.02 : https://developer.nvidia.com/vulkan-driver (Vulkan dev drivers page)
